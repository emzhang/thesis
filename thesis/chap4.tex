...
In section \ref{fixerfuture} I discuss what I envision future \texttt{Fixers} to look like based on the groundwork I have laid out for the fixing process.
...
\subsection{Performance vs. Space}
passing along hasher objects
storing things in lists instead of using generators
NHWR
