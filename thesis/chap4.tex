...
\begin{figure}[!ht]
\centering
\includegraphics[width =.9\textwidth]{k525violatargetshow}
\caption{Visual display of changes in viola part of target (MIDI) stream.}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width =.9\textwidth]{k525violasourceshow}
\caption{Visual display of changes in viola part of source (OMR) stream.}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width =.9\textwidth]{k525midistream}
\caption{Excerpt of original score taken from IMSLP}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width =.9\textwidth]{k525omrstream}
