...
\end{itemize}
        ...
        \subsubsection{Pre-Hashing: Low Level Note Settings}
                    ...
                    \item \texttt{\hashIsAccidental} = If \texttt{True}, this will return a boolean of whether the pitch of the hashed element is outside of the key signature. This setting is currently not fully supported. 
                    \end{itemize}
